        ...
        <div className="row">
          <div className="col-md-6">
            <div className={`${styles.contactDetailBox} mb-4`}>
              ...
              <p className={`${styles.contactDetailBoxPara} mb-2`}><MdLocationPin /> ISE Tower, 6Th floor Islamabad, Pakistan. 44000</p>
              <p className={`${styles.contactDetailBoxPara} mb-2`}><MdLocationPin /> Business Bay, Dubai, UAE.</p>
            </div>
            <div className={`${styles.contactDetailBox} mb-4`}>
              <h4 className={`${styles.contactDetailBoxHeading}`}>Phone</h4>
              <p className={`${styles.contactDetailBoxPara} mb-2`}><IoIosCall /> (+92) 315 5625755</p>
            </div>
            <div className={`${styles.contactDetailBox} mb-4`}>
              <h4 className={`${styles.contactDetailBoxHeading}`}>Email</h4>
              <p className={`${styles.contactDetailBoxPara} mb-2`}><IoIosMailOpen /> business@prohomez.com</p>
            </div>
          </div>
          <div className="col-md-6">
